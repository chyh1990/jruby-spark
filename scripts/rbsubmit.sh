...
$SPARK_HOME/bin/spark-submit  \
	--conf spark.driver.extraJavaOptions='-Djruby.ir.writing.dyn=true -Djruby.compile.invokedynamic=false' \
	--conf spark.executor.extraJavaOptions='-Djruby.compile.invokedynamic=false' \
